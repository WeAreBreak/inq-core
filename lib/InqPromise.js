...
function execute(context) {
    ...
    this.once('fulfilled', stop).once('rejected', stop)
...
//                throw new Error('You cannot yield iterators directly. Use yield* instead to await generator functions.')
                value = (new InqPromise(value, context)).done// TODO: Is it ok?
            else
